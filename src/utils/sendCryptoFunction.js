...
// Tinklų žemėlapis (normalizuoti trumpinius)
...
// GALUTINĖ SEND TRANSACTION FUNKCIJA
export async function sendTransaction({ to, amount, network, userEmail, gasOption = "average" }) {
  ...
  try {
    ...
    const insertData = {
      ...
      type: "send",
      tx_hash: userTxHash,
      status: "completed", // Visada completed
    };
